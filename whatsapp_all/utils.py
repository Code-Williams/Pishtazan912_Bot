...
def send_message(number, message, sleep_time, driver):
    ...
    try:
        ...
        if is_message_sent:
            ...
            driver.find_element_by_xpath("/html/body/div[1]/div/div/div[4]/div/footer/div[1]/div/span[2]/div/div[1]/div[2]/div/span/div/div/ul/li[4]/button").click().send_keys("C:\\Users\\Administrator\\Pictures\\ranges.pdf")
            time.sleep(1.5)
            return True
    except:
        is_number_invalid = driver.find_element_by_xpath("/html/body/div[1]/div/span[2]/div/span/div/div/div/div/div/div[1]")
